# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-22 21:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('diversidad_vegetal', models.IntegerField(choices=[(3, 'La diversidad de especies vegetales est\xe1 a un nivel \xf3ptimo'), (2, 'La diversidad vegetal debajo de una \xf3ptima con las medidas adoptadas'), (1, 'La diversidad de las especies vegetales a continuaci\xf3n \xf3ptima pero se toman medidas'), (0, 'Planta baja diversidad y ninguna de las medidas adoptadas')], verbose_name='23.1 Diversidad vegetal')),
                ('diversidad_genetica', models.IntegerField(choices=[(3, 'Sin el uso de Organismos gen\xe9ticamente modificados / Transg\xe9nicos. La diversidad gen\xe9tica est\xe1 aumentando'), (2, 'Sin el uso de Organismos gen\xe9ticamente modificados / Transg\xe9nicos. La diversidad gen\xe9tica en la granja se mantiene y se adopten medidas para incrementar la diversidad'), (1, 'Se toman medidas para reducir el uso de los Organismos gen\xe9ticamente modificados / Transg\xe9nicos. La diversidad gen\xe9tica en las explotaciones agr\xedcolas est\xe1 disminuyendo, pero se han tomado medidas'), (0, 'Uso intencional de Organismos gen\xe9ticamente modificados / Transg\xe9nicos. No se adoptan medidas para aumentar la diversidad gen\xe9tica')], verbose_name='23.2 Diversidad gen\xe9tica')),
                ('uso_tierra', models.IntegerField(choices=[(3, 'Ninguna destrucci\xf3n de ecosistemas de gran valor desde 2014 y la conversi\xf3n de ecosistemas naturales desde 2015'), (2, 'No hay ninguna conversi\xf3n de ecosistemas naturales desde 2015 y la compensaci\xf3n de las medidas adoptadas para la conversi\xf3n anterior'), (1, 'No hay ninguna conversi\xf3n de ecosistemas naturales desde 2015 y sin compensaci\xf3n de las medidas adoptadas'), (0, 'Conversi\xf3n de ecosistemas naturales desde 2015')], verbose_name='23.3 El uso de la tierra y la conversi\xf3n de la tierra')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('emision_carbono', models.IntegerField(choices=[(3, 'Cero quema de materia org\xe1nica en las granjas'), (2, 'Evidencia de baja emisi\xf3n de carbono y se toman medidas'), (1, 'Altas y bajas emisiones de carbono, pero se han tomado medidas para mejorar'), (0, 'Alta y baja emisi\xf3n de carbono sin que se tomen medidas')], verbose_name='22.1 El carbono y el \xf3xido nitroso (N2O): emisi\xf3n de carbono +')),
                ('procesamiento_transporte', models.IntegerField(choices=[(3, 'Productos transformados llegar al mercado con una \xf3ptima eficiencia de combustible'), (2, 'Los productos alcanzan el mercado estimado con alta eficiencia de combustible'), (1, 'Los productos llegan con baja eficiencia de uso de combustible pero adoptan medidas'), (0, 'Los productos llegan baja eficiencia de uso combustible (por v\xeda a\xe9rea, ...) y no adoptan medidas')], verbose_name='22.2 Emisiones de Carbono: durante el procesamiento y transporte')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('erosion', models.IntegerField(choices=[(3, 'Ninguna erosi\xf3n y ninguna compactaci\xf3n del suelo'), (2, 'Erosi\xf3n del suelo en peque\xf1a escala o compacto con medidas adoptadas'), (1, 'Erosi\xf3n del suelo a gran escala pero con medidas adoptadas'), (0, 'Erosi\xf3n del suelo a gran escala pero sin medidas')], verbose_name='19.1 Erosi\xf3n y/o compactaci\xf3n')),
                ('sanilizacion', models.IntegerField(choices=[(3, 'No hay historia de muy alto nivel de salinidad del suelo'), (2, 'Algunos casos de la salinidad del suelo, con las medidas adoptadas'), (1, 'Casos frecuentes de la salinidad del suelo, pero con medidas adoptadas'), (0, 'Casos frecuentes de la salinidad del suelo sin medidas adoptadas')], verbose_name='19.2 Salinizaci\xf3n')),
                ('contaminacion_suelo', models.IntegerField(choices=[(3, 'Niveles aceptables de contaminaci\xf3n (metales pesados, biol\xf3gicas) en el suelo sobre la base de datos de prueba de suelo'), (2, 'Pocos casos de contaminaci\xf3n adoptando medidas'), (1, 'Casos frecuentes de contaminaci\xf3n, sino adoptan medidas'), (0, 'Casos frecuentes de contaminaci\xf3n sin medidas')], verbose_name='19.3 Contaminaci\xf3n del suelo')),
                ('materia_organica', models.IntegerField(choices=[(3, 'Sin quema, acumulaci\xf3n de materia org\xe1nica del suelo'), (2, 'Pocos casos de quema, aumento de la materia org\xe1nica'), (1, 'Frecuentes casos de quema pero han adoptados medidas'), (0, 'Casos frecuentes de quema sin medidas adoptadas')], verbose_name='19.4 Materia org\xe1nica y el ciclo de nutrientes')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=250)),
                ('unidad_medida', models.CharField(choices=[('Libra', 'Libra'), ('Unidad', 'Unidad'), ('Docena', 'Docena'), ('Quintal', 'Quintal')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pruebas_suelo', models.IntegerField(choices=[(3, 'El an\xe1lisis del suelo es realizado recientemente en terreno/Granja/FO nivel que sea homog\xe9neo'), (2, 'Se realiza el an\xe1lisis del suelo, pero los datos son mayores de 5 a\xf1os y no refleja las condiciones no homog\xe9neos'), (1, 'Los datos de an\xe1lisis de suelo no est\xe1 disponible pero se han tomado medidas para obtener datos de suelos'), (0, 'No se dispone de datos de pruebas del suelo y ninguna de las medidas adoptadas para obtener datos')], verbose_name='21.1 Pruebas del suelo')),
                ('manejo_nutrientes', models.IntegerField(choices=[(3, 'Manejo de nutrientes es altamente eficiente'), (2, 'Manejo de nutrientes es casi eficiente y toman medidas'), (1, 'Manejo de nutrientes es ineficiente, sino se toman medidas'), (0, 'Manejo de nutrientes es ineficaz sin las medidas adoptadas')], verbose_name='21.2 Manejo de nutrientes')),
                ('fertilizante_organico', models.IntegerField(choices=[(3, 'Se ha optimizado el uso de fertilizantes org\xe1nicos'), (2, 'El uso de fertilizantes org\xe1nicos es casi \xf3ptima con las medidas adoptadas'), (1, 'El uso de fertilizantes org\xe1nicos est\xe1 lejos de ser \xf3ptima con las medidas adoptadas'), (0, 'El uso de fertilizantes org\xe1nicos est\xe1 lejos de optimizar sin las medidas adoptadas')], verbose_name='21.3 Fertilizante org\xe1nico')),
                ('balance', models.IntegerField(choices=[(2, 'Balance de N y P en la granja se mantiene'), (1, 'N y P fuera de equilibrio con las medidas adoptadas'), (0, 'N y P gravemente desequilibrado, pero tomar contramedidas')], verbose_name='21.4 Balance de nitr\xf3geno y f\xf3sforo')),
                ('gestion_residuos', models.IntegerField(choices=[(3, 'Todos los pasos identificados han sido adoptados. No hay signos de botar o derrame'), (2, 'La gesti\xf3n de los residuos en el lugar con medidas tomadas para mejorar a\xfan m\xe1s'), (1, 'Sin la gesti\xf3n de los residuos , pero las medidas adoptadas'), (0, 'La gesti\xf3n de residuos y sin ning\xfan tipo de medidas')], verbose_name='21.5 Gesti\xf3n de los residuos de la producci\xf3n para procesar')),
                ('gestion_envases', models.IntegerField(choices=[(3, 'Agricultura org\xe1nica sin dejar residuos, tales como contenedores de nocivos en el medio ambiente'), (2, 'Aplicaci\xf3n de un sistema para recoger, devolver o la eliminaci\xf3n segura de los envases de agroqu\xedmicos'), (1, 'Sin gesti\xf3n de residuos agroqu\xedmicos, pero las medidas adoptadas'), (0, 'Sin gesti\xf3n de residuos de agroqu\xedmicos y sin medidas')], verbose_name='21.6 Gesti\xf3n de envases vac\xedos de agroqu\xedmicos y productos agroqu\xedmicos sobrantes')),
                ('uso_pesticida', models.IntegerField(choices=[(3, 'No se utilizan plaguicidas sint\xe9ticos'), (2, 'Se aplican los plaguicidas de baja toxicidad y minimizada en consonancia con las Buenas Pr\xe1cticas Agr\xedcolas (GAP) y el "2017 SAN'), (1, 'Gobierno nacional aprob\xf3 los plaguicidas se aplican seg\xfan sus instrucciones de seguridad'), (0, 'Alta toxicidad o pesticidas ilegales son utilizados en forma no segura')], verbose_name='21.7 Uso de pesticida')),
                ('mip', models.IntegerField(choices=[(3, 'MIP es la estrategia para el control de plagas'), (2, 'MIP est\xe1 parcialmente aplicada y control qu\xedmico se combina con al menos dos m\xe9todos m\xe1s'), (1, 'MIP no se aplica todav\xeda, pero el control qu\xedmico es combinada con al menos un m\xe9todo m\xe1s (biol\xf3gicas, fisicas)'), (0, 'El control de plagas se basa principalmente en el control qu\xedmico (pesticidas sint\xe9ticos)')], verbose_name='21.8 MIP/MPN (Manejo integrado y gesti\xf3n de plagas naturales)')),
                ('encuesta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productores.Encuesta')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('salvaguardar_ecosistemas', models.IntegerField(choices=[(3, 'Los ecosistemas naturales y sus valores de conectividad est\xe1n aumentando'), (2, 'Los ecosistemas naturales est\xe1n bien documentados y mantenidos. Las medidas adoptadas para mejorar el ecosistema de valores'), (1, 'Los ecosistemas naturales son mantenidas, pero ninguna de las medidas adoptadas para mejorar el ecosistema de valores'), (0, 'Los ecosistemas naturales y sus valores est\xe1n disminuyendo. Ninguna de las medidas adoptadas para mejorar el ecosistema de valores')], verbose_name='24.1 Salvaguardar los ecosistemas naturales + conectividad')),
                ('proteccion_vida_silvestre', models.IntegerField(choices=[(3, 'No hay caza de animales silvestres'), (2, 'Caza legal sostenible a tarifa regulada'), (1, 'Caza legal pero no reglamentada'), (0, 'La caza ilegal o la caza en el ritmo insostenible')], verbose_name='24.2 Protecci\xf3n de la vida silvestre')),
                ('tierras_agricolas', models.IntegerField(choices=[(3, 'Utilizaci\xf3n de las tierras agr\xedcolas est\xe1 en su \xf3ptimo definido localmente'), (2, 'Utilizaci\xf3n de tierras agr\xedcolas est\xe1 por debajo de su \xf3ptimo definido localmente con las medidas adoptadas'), (1, 'Utilizaci\xf3n de tierras agr\xedcolas est\xe1 por debajo de su \xf3ptimo definido localmente sin las medidas adoptadas'), (0, 'Tierras de cultivo no es apta para la agricultura')], verbose_name='24.3 Uso \xf3ptimo de las tierras agr\xedcolas')),
                ('especies_invasoras', models.IntegerField(choices=[(3, 'No existen especies invasoras'), (2, 'S\xed hay especies invasoras, los agricultores adoptar contramedidas para reprimirlos'), (1, 'Los agricultores no son conscientes de los riesgos de las especies invasoras'), (0, 'Los agricultores son conscientes de especies invasoras, pero sin tomar medidas para suprimir la proliferaci\xf3n de especies invasoras')], verbose_name='24.4 Especies invasoras')),
                ('encuesta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productores.Encuesta')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo_costo_produccion', models.FileField(blank=True, null=True, upload_to=b'', verbose_name='Archivo costo producci\xf3n')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexo', models.CharField(choices=[('Mujer', 'Mujer'), ('Hombre', 'Hombre')], max_length=6, verbose_name='3. Sexo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gestion_riesgo', models.IntegerField(choices=[(3, 'El uso del agua para producir est\xe1 optimizado'), (2, 'El uso del agua es m\xe1s eficiente con las medidas adoptadas'), (1, 'El uso de agua no es eficiente, pero han adoptados medidas'), (0, 'Uso ineficiente del agua sin medidas adoptadas')], verbose_name='20.1 Gesti\xf3n del riego')),
                ('retencion_agua', models.IntegerField(choices=[(3, 'No hay casos de agua de escorrent\xeda, tiene retenci\xf3n de agua'), (2, 'Algunos casos de la escorrent\xeda y con las medidas adoptadas'), (1, 'Casos frecuentes de escorrent\xeda sino se toman medidas'), (0, 'Casos frecuentes de escorrent\xeda sin medidas')], verbose_name='20.2 Retenci\xf3n de agua y la escorrent\xeda')),
                ('eficiencia_agua', models.IntegerField(choices=[(3, 'El uso del agua en comparaci\xf3n con la salida est\xe1 optimizado'), (2, 'El uso del agua es m\xe1s eficiente con las medidas adoptadas'), (1, 'El uso de agua no es eficiente, si no toman medidas'), (0, 'Uso ineficiente del agua sin medidas')], verbose_name='20.3 Eficiencia del Agua (aplicable para el procesamiento)')),
                ('contaminacion_agua', models.IntegerField(choices=[(3, 'M\xednima contaminaci\xf3n de cuerpos de agua naturales (probado con regularidad en la comunidad)'), (2, 'Pocos casos de contaminaci\xf3n y las medidas adoptadas para mejorar las condiciones'), (1, 'Casos frecuentes de contaminaci\xf3n, pero realizan pruebas del agua y toman medidas'), (0, 'Contaminaci\xf3n frecuente, sin agua y sin medidas para mejorar las condiciones')], verbose_name='20.4 Contaminaci\xf3n del agua')),
                ('encuesta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productores.Encuesta')),
            ],
            options={
